...
class BaseVacation(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Vacation']] = 'Vacation'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.VacationActions[_PrismaModelT]':
        from .client import get_client

        return actions.VacationActions[_PrismaModelT](client or get_client(), cls)
...
class BaseVacationType(_PrismaModel):
    __prisma_model__: ClassVar[Literal['VacationType']] = 'VacationType'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.VacationTypeActions[_PrismaModelT]':
        from .client import get_client

        return actions.VacationTypeActions[_PrismaModelT](client or get_client(), cls)


class BaseVacationRequest(_PrismaModel):
    __prisma_model__: ClassVar[Literal['VacationRequest']] = 'VacationRequest'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.VacationRequestActions[_PrismaModelT]':
        from .client import get_client

        return actions.VacationRequestActions[_PrismaModelT](client or get_client(), cls)
